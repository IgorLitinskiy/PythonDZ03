...
if len(A_num) != N or N < N:
    ...
    for i in range(1, N):
        ...
        if count < min:
            min = count
            index = i
    print(f'Число {A_num[index]} в списке "A" близко по величине к числу {X}, их разница составляет {abs(X - A_num[index])}')